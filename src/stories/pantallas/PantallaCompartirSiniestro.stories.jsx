...
import { PantallaCompartirSiniestro } from "../../componentes";

export default {
  title: "Pantallas/Pantalla compartir siniestro",
  component: PantallaCompartirSiniestro,
};
    ...
    <Router>
      <Provider store={deposito}>
        <ApolloProvider client={Cliente}>
          <PantallaCompartirSiniestro {...args} />
        </ApolloProvider>
      </Provider>
    </Router>
  </div>

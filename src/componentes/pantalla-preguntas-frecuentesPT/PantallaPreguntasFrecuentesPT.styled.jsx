...
import { Titulo3, Subtitulo3 } from "../componentes-styled-compartidos/Textos";
...
const BotonDesplegarSecciones = styled.button`
  background-color: var(--fondo-blanco-normal) !important;
  border-radius: 3px;
  border-bottom: none;
  border-left: none;
  border-right: none;
  border: 1px solid var(--color-marca-normal);
  border-bottom: ${(props) =>
    props.desplegado
      ? "solid 1px var(--fondo-gris-claro)"
      : "solid 1px var(--color-marca-normal)"};

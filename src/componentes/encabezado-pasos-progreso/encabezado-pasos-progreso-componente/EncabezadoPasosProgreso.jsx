...
const EncabezadoPasosProgreso = (props) => {
  const { asistencia } = props;
  if (asistencia) {
    diccionario.titulo = "Asistencia de tu";
  }
...
EncabezadoPasosProgreso.propTypes = {
  asistencia: PropTypes.bool,
};

EncabezadoPasosProgreso.defaultProps = {
  asistencia: false,
};

...
import {
  ...
  ListaModal,
  ElementoListaModal,
} from "./SolicitudModal.styled";
import Boton from "../../boton";

const diccionario = {
  parrafo1: "Solicitud de reembolso de gastos medicos en linea",
  parrafo2:
    "El solicitante debe leer y aceptar previamente que HDI Seguros, S.A de C.V le permita el acceso a su portal electronico para solicitud directa de reembolsos de gastos medicos ('Formulario de Solicitud de Reembolso')",
  parrafo3:
...
const SolicitudModal = (props) => {
  const { titulo, textoBoton, asignarEstadoAlerta, subtitulo, tipo } = props;
